...
public class FramedPanel extends com.sencha.gxt.widget.core.client.FramedPanel {
  private Commands commands;
  
  private IWidgetFactory widgets;
  
  public FramedPanel(final Commands commands, final IWidgetFactory widgets) {
    super();
  ...
  public void addCommand(final BaseSimpleCommand command) {
    final Procedure1<TextButton> _function = new Procedure1<TextButton>() {
        public void apply(final TextButton it) {
          FramedPanel.this.addButton(it);
        }
