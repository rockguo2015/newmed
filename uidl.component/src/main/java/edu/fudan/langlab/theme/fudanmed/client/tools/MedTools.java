package edu.fudan.langlab.theme.fudanmed.client.tools;
...
public class MedTools extends Tools {

  public interface MedToolResources extends ToolResources, ClientBundle {

    @Source({"com/sencha/gxt/theme/base/client/tool/BaseTools.css", "MedTools.css"})
    ToolStyle style();
  ...
  public MedTools() {
    super(GWT.<ToolResources> create(MedToolResources.class));
  }
