...
public class TransferTemplate {
  public static String template(final RCTransferRecord value, final RCSystemParameter parameter, final TransferRecordItemMapper itemMapper) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("<html> ");
    _builder.newLine();
    _builder.append("<head> ");
    _builder.newLine();
    _builder.append("<title>\u8C03\u62E8\u5355</title> ");
    _builder.newLine();
    ...
    _builder.append("\u8C03\u62E8\u5355</h2>");
    _builder.newLineIfNotEmpty();
    _builder.append("<table> ");
    _builder.newLine();
    _builder.append("<tr> ");
    _builder.newLine();
    _builder.append("<td width=\"11%\" class=\"tdlabel tdleft tdbottom\">\u8C03\u62E8\u5355\u53F7:</td>");
    _builder.newLine();
    ...
    _builder.append("</td> ");
    _builder.newLineIfNotEmpty();
    _builder.append("<td width=\"11%\" class=\"tdlabel tdleft tdbottom\">\u8C03\u62E8\u65F6\u95F4:</td> ");
    _builder.newLine();
    ...
    _builder.append("</td> ");
    _builder.newLineIfNotEmpty();
    _builder.append("<td width=\"11%\" class=\"tdlabel tdleft tdbottom\">\u8C03\u5165\u4ED3\u5E93:</td> ");
    _builder.newLine();
    _builder.append("<td width=\"31%\" class=\"tdcontent\">");
    RCWarehouse _targetStore = value.getTargetStore();
    String _entityName = _targetStore.getEntityName();
    ...
    _builder.append("<tr> ");
    _builder.newLine();
    _builder.append("<td width=\"11%\" class=\"tdlabel tdleft tdbottom\">\u8C03\u51FA\u4ED3\u5E93:</td>");
    _builder.newLine();
    _builder.append("<td width=\"15%\" class=\"tdcontent\">");
    RCWarehouse _sourceStore = value.getSourceStore();
    String _entityName_1 = _sourceStore.getEntityName();
    _builder.append(_entityName_1, "");
    _builder.append("</td> ");
    _builder.newLineIfNotEmpty();
    _builder.append("<td width=\"11%\" class=\"tdlabel tdleft tdbottom\">\u64CD\u4F5C\u5458:</td> ");
    _builder.newLine();
    _builder.append("<td width=\"20%\" class=\"tdcontent\">");
    ...
    _builder.newLine();
    {
      Collection<RCTransferRecordItem> _items = value.getItems();
      ...
      for(final UITransferRecordItem record : _map) {
        ...
        _builder.newLineIfNotEmpty();
        _builder.append("<td>");
        RCProductEntryProxy _productEntry = record.getProductEntry();
        String _name = _productEntry.getName();
    ...
    _builder.append("<tr> ");
    _builder.newLine();
    _builder.append("<td width=\"30%\" class=\"tdlabel tdleft tdbottom\">&nbsp;</td>");
    _builder.newLine();
    _builder.append("<td width=\"17%\" class=\"tdlabel tdleft tdbottom\">\u8C03\u51FA\u4ED3\u5E93\u4ED3\u7BA1\u5458:</td> ");
    _builder.newLine();
    _builder.append("<td width=\"18%\" class=\"tdcontent\">&nbsp;</td> ");
    _builder.newLine();
    _builder.append("<td width=\"17%\" class=\"tdlabel tdleft tdbottom\">\u8C03\u5165\u4ED3\u5E93\u4ED3\u7BA1\u5458:</td> ");
    _builder.newLine();
    _builder.append("<td width=\"18%\" class=\"tdcontent\">&nbsp;</td>  ");
    _builder.newLine();
    _builder.append("</tr> ");
