...
@Component("com.fudanmed.platform.core.web.server.service.organization.EmployeeMapper")
public class EmployeeMapper extends AbstractEntityMapper<UIEmployee,RCEmployee> {
  @Autowired
  ...
  public UIEmployee copyFromEntity(final UIEmployee result, final RCEmployee entity) {
    ...
    result.setStatus(convertService.toValue(com.fudanmed.platform.core.web.shared.organization.UIEmployeeStatus.class,entity.getStatus()));
    result.setIsLeaveJob(convertService.toValue(java.lang.Boolean.class,entity.getIsLeaveJob()));
