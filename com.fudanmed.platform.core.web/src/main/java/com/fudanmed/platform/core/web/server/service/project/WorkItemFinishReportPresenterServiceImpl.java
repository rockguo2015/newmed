...
import com.fudanmed.platform.core.web.client.project.WorkItemFinishReportPresenterService;
import com.fudanmed.platform.core.web.server.service.project.WorkItemFinishReportDataValidator;
...
@Service("com.fudanmed.platform.core.web.client.project.WorkItemFinishReportPresenterService")
@Transactional
public class WorkItemFinishReportPresenterServiceImpl extends BaseService implements WorkItemFinishReportPresenterService {
  @Autowired
  private IObjectFactory entities;
  
  @Autowired
  private WorkItemFinishReportDataValidator validator;
  
  public void commit(final RCWorkItemTaskProxy context, final WorkItemFinishReportData data) throws SessionTimeOutException, ValidationException {
    Validates.<WorkItemFinishReportData>validateWith(data, this.validator);
  ...
  public Boolean getCanReport(final RCWorkItemTaskProxy context) throws SessionTimeOutException, ValidationException {
