...
import com.fudanmed.platform.core.web.client.deliver.DeliverOrganizationForm;
...
public class CreateOrUpdateDeliverOrganizationView extends FormViewerImpl<UIDeliverOrganization> implements CreateOrUpdateDeliverOrganizationPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private DeliverOrganizationForm form;
  
  public DeliverOrganizationForm doGetFormComponent() {
    return form;
  }
