...
import com.fudanmed.platform.core.web.client.measure.PhasedElectricMeasureValueForm;
...
public class CreateOrUpdatePhasedElectricMeasureValueView extends FormViewerImpl<UIPhasedElectricMeasureValue> implements CreateOrUpdatePhasedElectricMeasureValuePresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private PhasedElectricMeasureValueForm form;
  
  public PhasedElectricMeasureValueForm doGetFormComponent() {
    return form;
  }
