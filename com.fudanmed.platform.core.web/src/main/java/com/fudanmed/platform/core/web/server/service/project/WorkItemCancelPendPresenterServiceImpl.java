...
import com.fudanmed.platform.core.web.client.project.WorkItemCancelPendPresenterService;
import com.fudanmed.platform.core.web.server.service.project.WorkItemCancelPendDataValidator;
...
@Service("com.fudanmed.platform.core.web.client.project.WorkItemCancelPendPresenterService")
@Transactional
public class WorkItemCancelPendPresenterServiceImpl extends BaseService implements WorkItemCancelPendPresenterService {
  @Autowired
  private IObjectFactory entities;
  
  @Autowired
  private WorkItemCancelPendDataValidator validator;
  
  public void commit(final RCWorkItemTaskProxy context, final WorkItemCancelPendData data) throws SessionTimeOutException, ValidationException {
    Validates.<WorkItemCancelPendData>validateWith(data, this.validator);
