...
import com.fudanmed.platform.core.web.client.project.GroupTaskMisDispatchReportDataForm;
...
public class GroupTaskMisDispatchReportView extends ErrorNotifierViewer implements GroupTaskMisDispatchReportPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private GroupTaskMisDispatchReportDataForm form;
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          Widget _asWidget = GroupTaskMisDispatchReportView.this.form.asWidget();
              ...
              public void apply(final Widget it) {
                final Procedure1<Date> _function = new Procedure1<Date>() {
                    public void apply(final Date it) {
                      ...
                      GroupTaskMisDispatchReportView.this.form.finishDate.setValue(_trimDate);
                      GroupTaskMisDispatchReportView.this.form.finishTime.setValue(it);
                    }
                  };
                AsyncCallback<Date> _onSuccess = GroupTaskMisDispatchReportView.this.<Date>onSuccess(_function);
                GroupTaskMisDispatchReportView.this.timeService.getTime(_onSuccess);
              }
            };
          Widget _doubleArrow = ObjectExtensions.<Widget>operator_doubleArrow(_asWidget, _function);
          int _minus = (-1);
          VerticalLayoutData _VLayoutData = GroupTaskMisDispatchReportView.this.widgets.VLayoutData(1, _minus, 10);
  ...
  public GroupTaskMisDispatchReportData getValue() {
    GroupTaskMisDispatchReportData _value = this.form.getValue();
    return _value;
  }
