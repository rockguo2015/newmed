...
import com.fudanmed.platform.core.web.client.project.WorkItemPendDataForm;
...
public class WorkItemPendView extends ErrorNotifierViewer implements WorkItemPendPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private WorkItemPendDataForm form;
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          Widget _asWidget = WorkItemPendView.this.form.asWidget();
              ...
              public void apply(final Widget it) {
                final Procedure1<Date> _function = new Procedure1<Date>() {
                    public void apply(final Date it) {
                      ...
                      WorkItemPendView.this.form.finishDate.setValue(_trimDate);
                      WorkItemPendView.this.form.finishTime.setValue(it);
                    }
                  };
                AsyncCallback<Date> _onSuccess = WorkItemPendView.this.<Date>onSuccess(_function);
                WorkItemPendView.this.timeService.getTime(_onSuccess);
              }
            };
          Widget _doubleArrow = ObjectExtensions.<Widget>operator_doubleArrow(_asWidget, _function);
          int _minus = (-1);
          VerticalLayoutData _VLayoutData = WorkItemPendView.this.widgets.VLayoutData(1, _minus, 10);
  ...
  public WorkItemPendData getValue() {
    WorkItemPendData _value = this.form.getValue();
    return _value;
  }
