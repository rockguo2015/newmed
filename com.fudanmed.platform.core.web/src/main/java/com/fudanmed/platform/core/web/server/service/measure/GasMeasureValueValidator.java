...
@Component("com.fudanmed.platform.core.web.server.service.measure.GasMeasureValueValidator")
public class GasMeasureValueValidator implements IValidator<UIGasMeasureValue> {
  @Autowired
  ...
  public Collection<ValidationErrorItem> validate(final UIGasMeasureValue _entity) {
