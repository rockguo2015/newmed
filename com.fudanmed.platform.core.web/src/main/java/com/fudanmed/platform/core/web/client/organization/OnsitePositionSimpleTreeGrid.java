...
public class OnsitePositionSimpleTreeGrid extends GXTTreeGridComponent<UIOnsitePosition> implements IInitializerSupport {
  @Inject
  ...
  protected OnsitePositionSimpleTreeGrid doSetValue(final UIOnsitePosition value) {
    this.value = value;
