...
public class CreateDocumentStorageCommand extends BaseContextAwareSingleObjectCommand<IDocumentContainerProxy> implements IContextConsumer<IDocumentContainerProxy> {
  @Inject
  ...
  public String getActionId() {
    return "com.fudanmed.platform.core.web.CreateDocumentStorageCommand";
  }
