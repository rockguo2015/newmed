...
import com.fudanmed.platform.core.web.client.measure.MeasureDeviceValueManagementView;
import com.google.inject.ImplementedBy;
import com.uniquesoft.gwt.client.common.Viewer;

@ImplementedBy(value = MeasureDeviceValueManagementView.class)
public interface MeasureDeviceValueManagementPresenterView extends Viewer {
