...
@Component("com.fudanmed.platform.core.web.server.service.deliver.DeliverMaterialTypeValidator")
public class DeliverMaterialTypeValidator implements IValidator<UIDeliverMaterialType> {
  @Autowired
  ...
  public Collection<ValidationErrorItem> validate(final UIDeliverMaterialType _entity) {
