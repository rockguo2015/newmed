...
import com.fudanmed.platform.core.web.client.device.PartTypeSelectDataForm;
...
public class CreateOrUpdatePartTypeSelectDataView extends ErrorNotifierViewer implements CreateOrUpdatePartTypeSelectDataPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private PartTypeSelectDataForm form;
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          Widget _asWidget = CreateOrUpdatePartTypeSelectDataView.this.form.asWidget();
          int _minus = (-1);
          VerticalLayoutData _VLayoutData = CreateOrUpdatePartTypeSelectDataView.this.widgets.VLayoutData(1, _minus, 10);
  ...
  public UIPartTypeSelectData getValue() {
    UIPartTypeSelectData _value = this.form.getValue();
    return _value;
  }
  ...
  public void setValue(final UIPartTypeSelectData value) {
