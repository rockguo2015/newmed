...
import com.fudanmed.platform.core.web.client.deliver.CreateOrUpdateDeliverTaskFinishDataPresenterService;
...
@Service("com.fudanmed.platform.core.web.client.deliver.CreateOrUpdateDeliverTaskFinishDataPresenterService")
@Transactional
public class CreateOrUpdateDeliverTaskFinishDataPresenterServiceImpl extends BaseService implements CreateOrUpdateDeliverTaskFinishDataPresenterService {
  @Autowired
  private IObjectFactory entities;
  
  public void commit(final Collection<DLCenterlizedDeliverTaskProxy> deliverTasks, final UIDeliverTaskFinishData uivalue) throws SessionTimeOutException, ValidationException {
