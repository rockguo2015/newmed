...
import com.fudanmed.platform.core.web.client.measure.GasMeasureDeviceForm;
...
public class CreateOrUpdateGasMeasureDeviceView extends FormViewerImpl<UIGasMeasureDevice> implements CreateOrUpdateGasMeasureDevicePresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private GasMeasureDeviceForm form;
  
  public GasMeasureDeviceForm doGetFormComponent() {
    return form;
  }
