...
public class DevicePMPlanListView extends GWTAbstractView implements DevicePMPlanListPresenterView {
  ...
  public void initialize() {
    ...
    SGroupingGrid<UIDevicePMPlan> _asMultiSelectGrid = this.listGrid.asMultiSelectGrid();
    this.con = _asMultiSelectGrid;
  }
  
  public ActionContext<UIDevicePMPlan> getActionContext() {
    ActionContext<UIDevicePMPlan> _createActionContext = ActionExtensions.<UIDevicePMPlan>createActionContext(this.listGrid);
