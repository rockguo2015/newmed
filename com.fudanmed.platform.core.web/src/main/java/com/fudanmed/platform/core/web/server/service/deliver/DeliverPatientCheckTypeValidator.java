...
@Component("com.fudanmed.platform.core.web.server.service.deliver.DeliverPatientCheckTypeValidator")
public class DeliverPatientCheckTypeValidator implements IValidator<UIDeliverPatientCheckType> {
  @Autowired
  ...
  public Collection<ValidationErrorItem> validate(final UIDeliverPatientCheckType _entity) {
