...
@RemoteServiceRelativePath("service/com.fudanmed.platform.core.web.client.organization.OrganizationUploaderPresenterService")
public interface OrganizationUploaderPresenterService extends RemoteService {
