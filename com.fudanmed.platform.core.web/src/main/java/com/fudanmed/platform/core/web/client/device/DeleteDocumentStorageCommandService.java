...
@RemoteServiceRelativePath("service/com.fudanmed.platform.core.web.client.device.DeleteDocumentStorageCommandService")
public interface DeleteDocumentStorageCommandService extends RemoteService {
