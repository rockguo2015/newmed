...
import com.fudanmed.platform.core.web.client.measure.WaterMeasureValueForm;
...
public class CreateOrUpdateWaterMeasureValueView extends FormViewerImpl<UIWaterMeasureValue> implements CreateOrUpdateWaterMeasureValuePresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private WaterMeasureValueForm form;
  
  public WaterMeasureValueForm doGetFormComponent() {
    return form;
  }
