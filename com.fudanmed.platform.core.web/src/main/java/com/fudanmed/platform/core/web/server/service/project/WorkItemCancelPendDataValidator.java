...
@Component("com.fudanmed.platform.core.web.server.service.project.WorkItemCancelPendDataValidator")
public class WorkItemCancelPendDataValidator implements IValidator<WorkItemCancelPendData> {
  @Autowired
  ...
  public Collection<ValidationErrorItem> validate(final WorkItemCancelPendData _entity) {
