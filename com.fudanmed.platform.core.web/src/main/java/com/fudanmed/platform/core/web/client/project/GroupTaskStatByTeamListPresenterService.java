...
@RemoteServiceRelativePath("service/com.fudanmed.platform.core.web.client.project.GroupTaskStatByTeamListPresenterService")
public interface GroupTaskStatByTeamListPresenterService extends RemoteService {
