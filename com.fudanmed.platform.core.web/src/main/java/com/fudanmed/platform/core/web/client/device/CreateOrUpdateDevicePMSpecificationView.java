...
import com.fudanmed.platform.core.web.client.device.DevicePMSpecificationForm;
...
public class CreateOrUpdateDevicePMSpecificationView extends ErrorNotifierViewer implements CreateOrUpdateDevicePMSpecificationPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private DevicePMSpecificationForm form;
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          Widget _asWidget = CreateOrUpdateDevicePMSpecificationView.this.form.asWidget();
          int _minus = (-1);
          VerticalLayoutData _VLayoutData = CreateOrUpdateDevicePMSpecificationView.this.widgets.VLayoutData(1, _minus, 10);
  ...
  public UIDevicePMSpecification getValue() {
    UIDevicePMSpecification _value = this.form.getValue();
    return _value;
  }
  ...
  public void setValue(final UIDevicePMSpecification value) {
    this.form.setValue(value);
    Long _id = value.getId();
    boolean _notEquals = (!Objects.equal(_id, null));
    if (_notEquals) {
      FieldLabel _asWidget = this.form.device.asWidget();
      _asWidget.disable();
    }
  }
  
  public Size getSize() {
    Size _size = new Size(560, 340);
    return _size;
  }
  ...
  public void setDevice(final RCDeviceProxy device) {
    this.form.device.setValue(device);
  }
}
