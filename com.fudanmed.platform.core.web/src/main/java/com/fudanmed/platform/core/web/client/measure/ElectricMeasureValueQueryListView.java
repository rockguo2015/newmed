...
import com.fudanmed.platform.core.web.client.measure.ElectricMeasureValueListGrid;
...
public class ElectricMeasureValueQueryListView extends GWTAbstractView implements ElectricMeasureValueQueryListPresenterView {
  @Inject
  ...
  @Inject
  private ElectricMeasureValueListGrid listGrid;
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
                    ...
                    public void apply(final PlainHTMLTR it) {
                      ...
                      final Procedure1<PlainHTMLTD> _function = new Procedure1<PlainHTMLTD>() {
                          public void apply(final PlainHTMLTD it) {
                            FieldLabel _asWidget = ElectricMeasureValueQueryListView.this.criteriaForm.measureDateFrom.asWidget();
                      ...
                      final Procedure1<PlainHTMLTD> _function_1 = new Procedure1<PlainHTMLTD>() {
                          public void apply(final PlainHTMLTD it) {
                            FieldLabel _asWidget = ElectricMeasureValueQueryListView.this.criteriaForm.measureDateTo.asWidget();
                            ClientUi.operator_add(it, _asWidget);
                          }
                        };
                      ...
                      final Procedure1<PlainHTMLTD> _function_2 = new Procedure1<PlainHTMLTD>() {
                          public void apply(final PlainHTMLTD it) {
                            TextButton _TextButton = ElectricMeasureValueQueryListView.this.widgets.TextButton("\u67E5\u627E");
                                ...
                                public void apply(final TextButton it) {
                                  ...
                                  final Procedure1<SelectEvent> _function = new Procedure1<SelectEvent>() {
                                      public void apply(final SelectEvent it) {
                                        UIMeasureValueCriteria _value = ElectricMeasureValueQueryListView.this.criteriaForm.getValue();
                                        UIMeasureValueCriteria _withPagerInfo = Extensions.<UIMeasureValueCriteria>withPagerInfo(_value, ElectricMeasureValueQueryListView.this.pager);
          ...
          it.add(_doubleArrow);
          IPager<UIElectricMeasureValue> _createPager = edu.fudan.langlab.gxt.client.pager.Extensions.<UIElectricMeasureValue>createPager(ElectricMeasureValueQueryListView.this.listGrid);
          final Procedure1<IPager<UIElectricMeasureValue>> _function_1 = new Procedure1<IPager<UIElectricMeasureValue>>() {
              public void apply(final IPager<UIElectricMeasureValue> it) {
          ...
          IPager<UIElectricMeasureValue> _doubleArrow_1 = ObjectExtensions.<IPager<UIElectricMeasureValue>>operator_doubleArrow(_createPager, _function_1);
          ElectricMeasureValueQueryListView.this.pager = _doubleArrow_1;
          SGroupingGrid<UIElectricMeasureValue> _asWidget = ElectricMeasureValueQueryListView.this.listGrid.asWidget();
          VerticalLayoutData _VLayoutData = ElectricMeasureValueQueryListView.this.widgets.VLayoutData(1, 1);
          it.add(_asWidget, _VLayoutData);
          Widget _asWidget_1 = ElectricMeasureValueQueryListView.this.pager.asWidget();
          it.add(_asWidget_1);
        }
      };
  ...
  public void showResults(final IPagedResult<UIElectricMeasureValue> results) {
  ...
  public ActionContext<UIElectricMeasureValue> getActionContext() {
    ActionContext<UIElectricMeasureValue> _createActionContext = ActionExtensions.<UIElectricMeasureValue>createActionContext(this.listGrid);
