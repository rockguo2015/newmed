...
public class DeliverTaskFinishDataForm extends GXTFormComponent<UIDeliverTaskFinishData> implements IInitializerSupport {
  @Inject
  ...
  private UIDeliverTaskFinishData value = new UIDeliverTaskFinishData();
  ...
  public UIDeliverTaskFinishData getValueAsNew() {
    UIDeliverTaskFinishData value = new UIDeliverTaskFinishData();
    value.setComment(comment.getValue());
    return value;
  }
  
  public UIDeliverTaskFinishData doGetValue() {
    
    value.setComment(comment.getValue());
    return value;
  }
  
  public UIDeliverTaskFinishData getValue(final UIDeliverTaskFinishData copyValue) {
    
    copyValue.setComment(comment.getValue());
    return copyValue;
  }
  
  protected DeliverTaskFinishDataForm doSetValue(final UIDeliverTaskFinishData value) {
    this.value = value;
  ...
  public Widget createWidget() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          FieldLabel _asWidget = DeliverTaskFinishDataForm.this.comment.asWidget();
