...
public class ObjectNameService extends edu.fudan.langlab.uidl.domain.app.client.names.ObjectNameService {
  ...
  protected String _internalGetId(final UIOnsitePosition o) {
    Long _id = o.getId();
    String _string = _id.toString();
    return _string;
  }
  
  protected String _internalGetName(final UIOnsitePosition o) {
    String _fullPath = o.getFullPath();
    return _fullPath;
  }
  ...
  public String internalGetId(final Object o) {
    ...
    } else if (o instanceof UIOnsitePosition) {
      return _internalGetId((UIOnsitePosition)o);
  ...
  public String internalGetName(final Object o) {
    if (o instanceof UIDevice) {
      ...
      return _internalGetName((UIOnsitePosition)o);
    } else if (o instanceof UIFaultType) {
