...
import com.fudanmed.platform.core.web.client.device.PMDefaultIntervalAssociationForm;
...
public class CreateOrUpdatePMDefaultIntervalAssociationView extends FormViewerImpl<UIPMDefaultIntervalAssociation> implements CreateOrUpdatePMDefaultIntervalAssociationPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private PMDefaultIntervalAssociationForm form;
  
  public PMDefaultIntervalAssociationForm doGetFormComponent() {
    return form;
  }
  
  public Size getSize() {
    return new com.uniquesoft.gwt.client.common.widgets.Size(600,500);
  }
