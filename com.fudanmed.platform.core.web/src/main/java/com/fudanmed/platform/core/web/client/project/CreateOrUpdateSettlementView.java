...
import com.fudanmed.platform.core.web.client.project.SettlementForm;
...
public class CreateOrUpdateSettlementView extends ErrorNotifierViewer implements CreateOrUpdateSettlementPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          Widget _asWidget = CreateOrUpdateSettlementView.this.form.asWidget();
          int _minus = (-1);
          VerticalLayoutData _VLayoutData = CreateOrUpdateSettlementView.this.widgets.VLayoutData(1, _minus, 10);
  ...
  public UISettlement getValue() {
    UISettlement _value = this.form.getValue();
    return _value;
  }
  ...
  public void setValue(final UISettlement value) {
