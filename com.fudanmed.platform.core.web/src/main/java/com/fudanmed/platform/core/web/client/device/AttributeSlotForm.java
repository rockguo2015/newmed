...
public class AttributeSlotForm extends GXTFormComponent<UIAttributeSlot> implements IInitializerSupport {
  @Inject
  ...
  protected AttributeSlotForm doSetValue(final UIAttributeSlot value) {
    this.value = value;
  ...
  public Widget asWidget() {
    final Function1<Void,VerticalLayoutContainer> _function = new Function1<Void,VerticalLayoutContainer>() {
        public VerticalLayoutContainer apply(final Void it) {
          VerticalLayoutContainer _VLayout = AttributeSlotForm.this.widgets.VLayout();
