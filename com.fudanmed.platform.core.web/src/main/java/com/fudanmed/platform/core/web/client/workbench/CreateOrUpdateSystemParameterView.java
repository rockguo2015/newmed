...
import com.fudanmed.platform.core.web.client.workbench.SystemParameterForm;
...
public class CreateOrUpdateSystemParameterView extends ErrorNotifierViewer implements CreateOrUpdateSystemParameterPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private SystemParameterForm form;
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          Widget _asWidget = CreateOrUpdateSystemParameterView.this.form.asWidget();
          int _minus = (-1);
          VerticalLayoutData _VLayoutData = CreateOrUpdateSystemParameterView.this.widgets.VLayoutData(1, _minus, 10);
  ...
  public UISystemParameter getValue() {
    UISystemParameter _value = this.form.getValue();
    return _value;
  }
  ...
  public void setValue(final UISystemParameter value) {
    this.form.setValue(value);
  }
  
  public Size getSize() {
    Size _size = new Size(300, 250);
    return _size;
  }
