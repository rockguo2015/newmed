...
public class CreateDeliverMaterialCategoryCommand extends BaseContextAwareSingleObjectCommand<DLDeliverMaterialCategoryProxy> implements IContextConsumer<DLDeliverMaterialCategoryProxy> {
  @Inject
  ...
  public String getActionId() {
    return "com.fudanmed.platform.core.web.CreateDeliverMaterialCategoryCommand";
  }
  ...
  public void execute(final DLDeliverMaterialCategoryProxy value) {
    ...
    _get.setup4Create(value, new IPresenterInitiazerNotifier<CreateOrUpdateDeliverMaterialCategoryPresenter>() {
