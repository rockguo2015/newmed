...
public class DocumentStorageListView extends GWTAbstractView implements DocumentStorageListPresenterView {
  @Inject
  ...
  public void initialize() {
    ...
    ImageResource _download = MedImages.INSTANCE.download();
    this.listGrid.download.setImage(_download);
  }
