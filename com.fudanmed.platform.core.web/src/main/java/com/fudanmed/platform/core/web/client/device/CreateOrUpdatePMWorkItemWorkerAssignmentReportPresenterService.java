...
@RemoteServiceRelativePath("service/com.fudanmed.platform.core.web.client.device.CreateOrUpdatePMWorkItemWorkerAssignmentReportPresenterService")
public interface CreateOrUpdatePMWorkItemWorkerAssignmentReportPresenterService extends RemoteService {
