...
public class UIWorkbenchPartRegister {
  ...
  public void initialize() {
    ...
    final WorkbenchCategoryImpl warehouseCategory = _workbenchCategoryImpl_5;
    this.workbenchManager.registerPresenterCategory(warehouseCategory);
    ...
    this.workbenchManager.registerPresenterProxy(
      ...
      "\u76D8\u70B9\u7BA1\u7406");
    this.workbenchManager.registerCommand(warehouseCategory, this.showProductSummarySnapshotManagementCommand);
    ...
    this.workbenchManager.registerCommand(deliverCategory, this.showDeliverOrganizationManagementCommand);
  }
}
