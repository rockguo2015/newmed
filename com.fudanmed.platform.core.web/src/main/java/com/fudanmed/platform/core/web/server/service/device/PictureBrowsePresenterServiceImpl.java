...
import com.fudanmed.platform.core.web.client.device.PictureBrowsePresenterService;
...
@Service("com.fudanmed.platform.core.web.client.device.PictureBrowsePresenterService")
@Transactional
public class PictureBrowsePresenterServiceImpl extends BaseService implements PictureBrowsePresenterService {
  @Autowired
  ...
  public Collection<UIDocumentStorage> loadDocumentStorageList(final IHasDocumentsProxy context) throws SessionTimeOutException, ValidationException {
    ...
    final Function1<IDocument,UIDocumentStorage> _function = new Function1<IDocument,UIDocumentStorage>() {
        public UIDocumentStorage apply(final IDocument it) {
          UIDocumentStorage _transform = PictureBrowsePresenterServiceImpl.this.mapper.transform(((DocumentStorage) it));
          return _transform;
        }
      };
