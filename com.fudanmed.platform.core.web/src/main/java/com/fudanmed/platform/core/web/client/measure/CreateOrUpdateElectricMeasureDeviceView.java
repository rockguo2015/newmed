...
import com.fudanmed.platform.core.web.client.measure.ElectricMeasureDeviceForm;
...
public class CreateOrUpdateElectricMeasureDeviceView extends FormViewerImpl<UIElectricMeasureDevice> implements CreateOrUpdateElectricMeasureDevicePresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private ElectricMeasureDeviceForm form;
  
  public ElectricMeasureDeviceForm doGetFormComponent() {
    return form;
  }
