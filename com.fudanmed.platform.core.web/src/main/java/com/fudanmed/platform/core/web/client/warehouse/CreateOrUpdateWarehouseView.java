...
import com.fudanmed.platform.core.web.client.warehouse.WarehouseForm;
...
public class CreateOrUpdateWarehouseView extends ErrorNotifierViewer implements CreateOrUpdateWarehousePresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          Widget _asWidget = CreateOrUpdateWarehouseView.this.form.asWidget();
          int _minus = (-1);
          VerticalLayoutData _VLayoutData = CreateOrUpdateWarehouseView.this.widgets.VLayoutData(1, _minus, 10);
  ...
  public UIWarehouse getValue() {
    UIWarehouse _value = this.form.getValue();
    return _value;
  }
  ...
  public void setValue(final UIWarehouse value) {
    this.form.setValue(value);
  }
  
  public Size getSize() {
    Size _size = new Size(680, 360);
    return _size;
  }
