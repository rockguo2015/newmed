...
public class CreatePhasedElectricMeasureValueCommand extends BaseContextAwareSingleObjectCommand<RCMeasureDeviceProxy> implements IContextConsumer<RCMeasureDeviceProxy> {
  @Inject
  ...
  public String getActionId() {
    return "com.fudanmed.platform.core.web.CreatePhasedElectricMeasureValueCommand";
  }
  ...
  public void execute(final RCMeasureDeviceProxy value) {
    ...
    _get.setup4Create(value, new IPresenterInitiazerNotifier<CreateOrUpdatePhasedElectricMeasureValuePresenter>() {
