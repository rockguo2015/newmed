...
import com.fudanmed.platform.core.web.client.deliver.CreateOrUpdateDeliverTaskFinishDataPresenterServiceAsync;
...
public class CreateOrUpdateDeliverTaskFinishDataPresenter extends WorkbenchAbstractPresenter<CreateOrUpdateDeliverTaskFinishDataPresenterView> implements CommitablePresenter {
  @Inject
  protected CreateOrUpdateDeliverTaskFinishDataPresenterServiceAsync _service;
  
  @Inject
  public CreateOrUpdateDeliverTaskFinishDataPresenter(final CreateOrUpdateDeliverTaskFinishDataPresenterView display, final EventBus eventBus) {
    super(display,eventBus);
  }
  
  private Procedure1<? super CommitResultNotifier> commiter;
  
  public void setup4Create(final Iterable<UICenterlizedDeliverTask> deliverTasks, final IPresenterInitiazerNotifier<CreateOrUpdateDeliverTaskFinishDataPresenter> _notifier) {
    ...
    final Procedure1<CommitResultNotifier> _function = new Procedure1<CommitResultNotifier>() {
        public void apply(final CommitResultNotifier notifier) {
          ...
          CreateOrUpdateDeliverTaskFinishDataPresenterView _view = CreateOrUpdateDeliverTaskFinishDataPresenter.this.getView();
          UIDeliverTaskFinishData _value = _view.getValue();
          ...
          AsyncCallback<Void> _onSuccess = CreateOrUpdateDeliverTaskFinishDataPresenter.this.<Void>onSuccess(_function_1);
          _service.commit(_list, _value, _onSuccess);
        }
      };
    this.commiter = _function;
    final Procedure1<Void> _function_1 = new Procedure1<Void>() {
        public void apply(final Void it) {_notifier.done(CreateOrUpdateDeliverTaskFinishDataPresenter.this);
        }
      };
