...
public class ProductWarehouseStorageList extends GXTListViewComponent<UIProductWarehouseStorage> implements IInitializerSupport {
  @Inject
  private IWidgetFactory widgets;
  
  public SafeHtml render(final UIProductWarehouseStorage value) {
    return ((com.fudanmed.platform.core.web.client.warehouse.ProductWarehouseStorageListRenderTemplate)com.google.gwt.core.client.GWT.create(com.fudanmed.platform.core.web.client.warehouse.ProductWarehouseStorageListRenderTemplate.class)).render(
    	value
    );
  ...
  protected ProductWarehouseStorageList doSetValue(final UIProductWarehouseStorage value) {
    this.value = value;
