...
import com.fudanmed.platform.core.web.client.deliver.DeliverTaskCancelDispatchDataForm;
...
public class CreateOrUpdateDeliverTaskCancelDispatchDataView extends FormViewerImpl<UIDeliverTaskCancelDispatchData> implements CreateOrUpdateDeliverTaskCancelDispatchDataPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private DeliverTaskCancelDispatchDataForm form;
  
  public DeliverTaskCancelDispatchDataForm doGetFormComponent() {
    return form;
  }
