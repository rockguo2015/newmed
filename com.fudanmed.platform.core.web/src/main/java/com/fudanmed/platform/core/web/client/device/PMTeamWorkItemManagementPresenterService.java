...
@RemoteServiceRelativePath("service/com.fudanmed.platform.core.web.client.device.PMTeamWorkItemManagementPresenterService")
public interface PMTeamWorkItemManagementPresenterService extends RemoteService {
