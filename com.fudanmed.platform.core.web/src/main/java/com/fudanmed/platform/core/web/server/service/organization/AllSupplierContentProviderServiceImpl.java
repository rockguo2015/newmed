...
import com.fudanmed.platform.core.web.client.organization.AllSupplierContentProviderService;
...
@Service("com.fudanmed.platform.core.web.client.organization.AllSupplierContentProviderService")
@Transactional
public class AllSupplierContentProviderServiceImpl extends BaseContentProviderService implements AllSupplierContentProviderService {
  @Autowired
  ...
  public Collection<RCSupplierProxy> load(final AllSupplierContentProviderCriteria filter) {
  ...
  public Collection<RCSupplier> doLoad(final AllSupplierContentProviderCriteria filter) {
    ...
    final Procedure1<RCSupplierCriteria> _function = new Procedure1<RCSupplierCriteria>() {
        public void apply(final RCSupplierCriteria it) {
          ...
          it.setInfo(_name);
          it.setType(RCSupplierType.materialSupplier);
        }
      };
