...
@Component("com.fudanmed.platform.core.web.server.service.device.DeviceCSVMapperSupplier")
public class DeviceCSVMapperSupplier extends BaseCSVCustomItemMapper<RCSupplierProxy,UIDevice> {
  @Autowired
