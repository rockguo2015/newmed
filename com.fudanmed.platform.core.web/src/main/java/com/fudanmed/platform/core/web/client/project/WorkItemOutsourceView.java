...
import com.fudanmed.platform.core.web.client.project.WorkItemOutsourceDataForm;
...
public class WorkItemOutsourceView extends ErrorNotifierViewer implements WorkItemOutsourcePresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private WorkItemOutsourceDataForm form;
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          Widget _asWidget = WorkItemOutsourceView.this.form.asWidget();
              ...
              public void apply(final Widget it) {
                final Procedure1<Date> _function = new Procedure1<Date>() {
                    public void apply(final Date it) {
                      ...
                      WorkItemOutsourceView.this.form.finishDate.setValue(_trimDate);
                      WorkItemOutsourceView.this.form.finishTime.setValue(it);
                    }
                  };
                AsyncCallback<Date> _onSuccess = WorkItemOutsourceView.this.<Date>onSuccess(_function);
                WorkItemOutsourceView.this.timeService.getTime(_onSuccess);
              }
            };
          Widget _doubleArrow = ObjectExtensions.<Widget>operator_doubleArrow(_asWidget, _function);
          int _minus = (-1);
          VerticalLayoutData _VLayoutData = WorkItemOutsourceView.this.widgets.VLayoutData(1, _minus, 10);
  ...
  public WorkItemOutsourceData getValue() {
    WorkItemOutsourceData _value = this.form.getValue();
    return _value;
  }
