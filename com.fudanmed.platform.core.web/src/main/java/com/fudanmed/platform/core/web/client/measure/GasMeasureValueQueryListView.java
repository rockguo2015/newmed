...
import com.fudanmed.platform.core.web.client.measure.GasMeasureValueListGrid;
...
public class GasMeasureValueQueryListView extends GWTAbstractView implements GasMeasureValueQueryListPresenterView {
  @Inject
  ...
  @Inject
  private GasMeasureValueListGrid listGrid;
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
                    ...
                    public void apply(final PlainHTMLTR it) {
                      ...
                      final Procedure1<PlainHTMLTD> _function = new Procedure1<PlainHTMLTD>() {
                          public void apply(final PlainHTMLTD it) {
                            FieldLabel _asWidget = GasMeasureValueQueryListView.this.criteriaForm.measureDateFrom.asWidget();
                      ...
                      final Procedure1<PlainHTMLTD> _function_1 = new Procedure1<PlainHTMLTD>() {
                          public void apply(final PlainHTMLTD it) {
                            FieldLabel _asWidget = GasMeasureValueQueryListView.this.criteriaForm.measureDateTo.asWidget();
                            ClientUi.operator_add(it, _asWidget);
                          }
                        };
                      ...
                      final Procedure1<PlainHTMLTD> _function_2 = new Procedure1<PlainHTMLTD>() {
                          public void apply(final PlainHTMLTD it) {
                            TextButton _TextButton = GasMeasureValueQueryListView.this.widgets.TextButton("\u67E5\u627E");
                                ...
                                public void apply(final TextButton it) {
                                  ...
                                  final Procedure1<SelectEvent> _function = new Procedure1<SelectEvent>() {
                                      public void apply(final SelectEvent it) {
                                        UIMeasureValueCriteria _value = GasMeasureValueQueryListView.this.criteriaForm.getValue();
                                        UIMeasureValueCriteria _withPagerInfo = Extensions.<UIMeasureValueCriteria>withPagerInfo(_value, GasMeasureValueQueryListView.this.pager);
          ...
          it.add(_doubleArrow);
          IPager<UIGasMeasureValue> _createPager = edu.fudan.langlab.gxt.client.pager.Extensions.<UIGasMeasureValue>createPager(GasMeasureValueQueryListView.this.listGrid);
          final Procedure1<IPager<UIGasMeasureValue>> _function_1 = new Procedure1<IPager<UIGasMeasureValue>>() {
              public void apply(final IPager<UIGasMeasureValue> it) {
          ...
          IPager<UIGasMeasureValue> _doubleArrow_1 = ObjectExtensions.<IPager<UIGasMeasureValue>>operator_doubleArrow(_createPager, _function_1);
          GasMeasureValueQueryListView.this.pager = _doubleArrow_1;
          SGroupingGrid<UIGasMeasureValue> _asWidget = GasMeasureValueQueryListView.this.listGrid.asWidget();
          VerticalLayoutData _VLayoutData = GasMeasureValueQueryListView.this.widgets.VLayoutData(1, 1);
          it.add(_asWidget, _VLayoutData);
          Widget _asWidget_1 = GasMeasureValueQueryListView.this.pager.asWidget();
          it.add(_asWidget_1);
        }
      };
  ...
  public void showResults(final IPagedResult<UIGasMeasureValue> results) {
  ...
  public ActionContext<UIGasMeasureValue> getActionContext() {
    ActionContext<UIGasMeasureValue> _createActionContext = ActionExtensions.<UIGasMeasureValue>createActionContext(this.listGrid);
