...
import com.fudanmed.platform.core.web.client.device.NumberWithUnitTypeForm;
...
public class CreateOrUpdateNumberWithUnitTypeView extends ErrorNotifierViewer implements CreateOrUpdateNumberWithUnitTypePresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private NumberWithUnitTypeForm form;
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          Widget _asWidget = CreateOrUpdateNumberWithUnitTypeView.this.form.asWidget();
          int _minus = (-1);
          VerticalLayoutData _VLayoutData = CreateOrUpdateNumberWithUnitTypeView.this.widgets.VLayoutData(1, _minus, 10);
  ...
  public UINumberWithUnitType getValue() {
    UINumberWithUnitType _value = this.form.getValue();
    return _value;
  }
  ...
  public void setValue(final UINumberWithUnitType value) {
