...
public class ProductSpecificationUploaderView extends ErrorNotifierViewer implements ProductSpecificationUploaderPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          Widget _asWidget = ProductSpecificationUploaderView.this.uploadForm.asWidget();
          int _minus = (-1);
          VerticalLayoutData _VLayoutData = ProductSpecificationUploaderView.this.widgets.VLayoutData(1, _minus, 10);
