...
import com.fudanmed.platform.core.web.client.device.DeletePictureCommandServiceAsync;
...
public class DeletePictureCommand extends BaseContextAwareSingleObjectCommand<DocumentStorageProxy> implements IContextConsumer<DocumentStorageProxy> {
  @Inject
  protected DeletePictureCommandServiceAsync _service;
  ...
  public String getActionId() {
    return "com.fudanmed.platform.core.web.DeletePictureCommand";
  }
  ...
  public void execute(final DocumentStorageProxy value) {
    ...
    final Procedure1<Void> _function = new Procedure1<Void>() {
        public void apply(final Void it) {
          ...
          AsyncCallback<Void> _onSuccess = DeletePictureCommand.this.<Void>onSuccess(_function);
