...
@RemoteServiceRelativePath("service/com.fudanmed.platform.core.web.client.device.PictureListPresenterService")
public interface PictureListPresenterService extends RemoteService {
