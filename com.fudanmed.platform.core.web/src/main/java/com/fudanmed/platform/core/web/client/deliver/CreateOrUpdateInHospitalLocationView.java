...
import com.fudanmed.platform.core.web.client.deliver.InHospitalLocationForm;
...
public class CreateOrUpdateInHospitalLocationView extends FormViewerImpl<UIInHospitalLocation> implements CreateOrUpdateInHospitalLocationPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private InHospitalLocationForm form;
  
  public InHospitalLocationForm doGetFormComponent() {
    return form;
  }
  
  public Size getSize() {
    return new com.uniquesoft.gwt.client.common.widgets.Size(350,200);
  }
        ...
        public void apply(final PlainHTMLTable it) {
              ...
              public void apply(final PlainHTMLTR it) {
                ...
                final Procedure1<PlainHTMLTD> _function = new Procedure1<PlainHTMLTD>() {
                    public void apply(final PlainHTMLTD it) {
                      FieldLabel _asWidget = CreateOrUpdateInHospitalLocationView.this.form.code.asWidget();
          ...
          final Procedure1<PlainHTMLTR> _function_1 = new Procedure1<PlainHTMLTR>() {
              public void apply(final PlainHTMLTR it) {
                ...
                final Procedure1<PlainHTMLTD> _function = new Procedure1<PlainHTMLTD>() {
                    public void apply(final PlainHTMLTD it) {
                      FieldLabel _asWidget = CreateOrUpdateInHospitalLocationView.this.form.name.asWidget();
                      ClientUi.operator_add(it, _asWidget);
                    }
                  };
                ObjectExtensions.<PlainHTMLTD>operator_doubleArrow(_td, _function);
                          ...
                          public void apply(final PlainHTMLTable it) {
                            ...
                            final Procedure1<PlainHTMLTR> _function = new Procedure1<PlainHTMLTR>() {
                                public void apply(final PlainHTMLTR it) {
                                  ...
                                  final Procedure1<PlainHTMLTD> _function = new Procedure1<PlainHTMLTD>() {
                                      public void apply(final PlainHTMLTD it) {
                                        FieldLabel _asWidget = CreateOrUpdateInHospitalLocationView.this.form.location.asWidget();
                                        ClientUi.operator_add(it, _asWidget);
                                      }
                                    };
                                  ObjectExtensions.<PlainHTMLTD>operator_doubleArrow(_td, _function);
                                  ...
                                  final Procedure1<PlainHTMLTD> _function_1 = new Procedure1<PlainHTMLTD>() {
                                      public void apply(final PlainHTMLTD it) {
                                        TextButton _TextButton = CreateOrUpdateInHospitalLocationView.this.widgets.TextButton("\u9009\u62E9");
                                            ...
                                            public void apply(final TextButton it) {
                                              final Procedure1<SelectEvent> _function = new Procedure1<SelectEvent>() {
                                                  public void apply(final SelectEvent it) {
                                                    OnsiteLocationOutlinePresenter _get = CreateOrUpdateInHospitalLocationView.this.onsiteLocationOutlinePresenter.get();
                                                        ...
                                                        public void apply(final OnsiteLocationOutlinePresenter it) {
                                                          final Procedure1<UIOnsitePosition> _function = new Procedure1<UIOnsitePosition>() {
                                                              public void apply(final UIOnsitePosition it) {
                                                                ...
                                                                CreateOrUpdateInHospitalLocationView.this.form.location.setValue(_proxy);
                                                              }
                                                            };
