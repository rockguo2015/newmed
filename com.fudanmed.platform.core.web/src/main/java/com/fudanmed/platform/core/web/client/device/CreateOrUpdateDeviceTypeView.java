...
import com.fudanmed.platform.core.web.client.device.DeviceTypeForm;
...
public class CreateOrUpdateDeviceTypeView extends ErrorNotifierViewer implements CreateOrUpdateDeviceTypePresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          Widget _asWidget = CreateOrUpdateDeviceTypeView.this.form.asWidget();
          int _minus = (-1);
          VerticalLayoutData _VLayoutData = CreateOrUpdateDeviceTypeView.this.widgets.VLayoutData(1, _minus, 10);
  ...
  public UIDeviceType getValue() {
    UIDeviceType _value = this.form.getValue();
    return _value;
  }
  ...
  public void setValue(final UIDeviceType value) {
