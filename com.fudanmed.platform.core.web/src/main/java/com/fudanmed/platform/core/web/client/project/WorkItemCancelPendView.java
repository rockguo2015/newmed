...
import com.fudanmed.platform.core.web.client.project.WorkItemCancelPendDataForm;
...
public class WorkItemCancelPendView extends ErrorNotifierViewer implements WorkItemCancelPendPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private WorkItemCancelPendDataForm form;
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          Widget _asWidget = WorkItemCancelPendView.this.form.asWidget();
              ...
              public void apply(final Widget it) {
                final Procedure1<Date> _function = new Procedure1<Date>() {
                    public void apply(final Date it) {
                      ...
                      WorkItemCancelPendView.this.form.finishDate.setValue(_trimDate);
                      WorkItemCancelPendView.this.form.finishTime.setValue(it);
                    }
                  };
                AsyncCallback<Date> _onSuccess = WorkItemCancelPendView.this.<Date>onSuccess(_function);
                WorkItemCancelPendView.this.timeService.getTime(_onSuccess);
                FieldLabel _asWidget = WorkItemCancelPendView.this.form.alsoReport.asWidget();
                ...
                FieldLabel _asWidget_1 = WorkItemCancelPendView.this.form.reportComment.asWidget();
          ...
          int _minus = (-1);
          VerticalLayoutData _VLayoutData = WorkItemCancelPendView.this.widgets.VLayoutData(1, _minus, 10);
  ...
  public WorkItemCancelPendData getValue() {
    WorkItemCancelPendData _value = this.form.getValue();
    return _value;
  }
  ...
  public void canReport() {
    ...
    final Procedure1<FieldLabel> _function = new Procedure1<FieldLabel>() {
        public void apply(final FieldLabel it) {
          WorkItemCancelPendView.this.form.alsoReport.setValue(Boolean.valueOf(true));
          it.enable();
        }
      };
