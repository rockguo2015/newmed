...
import com.fudanmed.platform.core.web.client.warehouse.ProductCategoryForm;
...
public class CreateOrUpdateProductCategoryView extends ErrorNotifierViewer implements CreateOrUpdateProductCategoryPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private ProductCategoryForm form;
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          Widget _asWidget = CreateOrUpdateProductCategoryView.this.form.asWidget();
          int _minus = (-1);
          VerticalLayoutData _VLayoutData = CreateOrUpdateProductCategoryView.this.widgets.VLayoutData(1, _minus, 10);
  ...
  public UIProductCategory getValue() {
    UIProductCategory _value = this.form.getValue();
    return _value;
  }
  ...
  public void setValue(final UIProductCategory value) {
