...
@Component("com.fudanmed.platform.core.web.server.service.deliver.DeliverMaterialCategoryValidator")
public class DeliverMaterialCategoryValidator implements IValidator<UIDeliverMaterialCategory> {
  @Autowired
  ...
  public Collection<ValidationErrorItem> validate(final UIDeliverMaterialCategory _entity) {
