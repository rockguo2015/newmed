...
import com.fudanmed.platform.core.web.client.device.DeviceTypeCategoryForm;
...
public class CreateOrUpdateDeviceTypeCategoryView extends ErrorNotifierViewer implements CreateOrUpdateDeviceTypeCategoryPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private DeviceTypeCategoryForm form;
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          Widget _asWidget = CreateOrUpdateDeviceTypeCategoryView.this.form.asWidget();
          int _minus = (-1);
          VerticalLayoutData _VLayoutData = CreateOrUpdateDeviceTypeCategoryView.this.widgets.VLayoutData(1, _minus, 10);
  ...
  public UIDeviceTypeCategory getValue() {
    UIDeviceTypeCategory _value = this.form.getValue();
    return _value;
  }
  ...
  public void setValue(final UIDeviceTypeCategory value) {
