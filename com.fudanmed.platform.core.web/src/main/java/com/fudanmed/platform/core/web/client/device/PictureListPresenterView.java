...
import com.fudanmed.platform.core.web.client.device.PictureListView;
...
@ImplementedBy(value = PictureListView.class)
public interface PictureListPresenterView extends Viewer, IContextProvider<UIDocumentStorage> {
