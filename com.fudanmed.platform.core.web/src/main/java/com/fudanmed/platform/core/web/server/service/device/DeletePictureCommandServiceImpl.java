...
import com.fudanmed.platform.core.web.client.device.DeletePictureCommandService;
...
@Service("com.fudanmed.platform.core.web.client.device.DeletePictureCommandService")
@Transactional
public class DeletePictureCommandServiceImpl extends BaseService implements DeletePictureCommandService {
  @Autowired
