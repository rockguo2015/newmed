...
import com.fudanmed.platform.core.web.client.deliver.DeliverMaterialCategoryForm;
...
public class CreateOrUpdateDeliverMaterialCategoryView extends FormViewerImpl<UIDeliverMaterialCategory> implements CreateOrUpdateDeliverMaterialCategoryPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private DeliverMaterialCategoryForm form;
  
  public DeliverMaterialCategoryForm doGetFormComponent() {
    return form;
  }
  ...
  public void setParent(final DLDeliverMaterialCategoryProxy parent) {
