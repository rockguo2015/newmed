...
import com.fudanmed.platform.core.web.client.device.DocumentStorageListPresenterService;
...
@Service("com.fudanmed.platform.core.web.client.device.DocumentStorageListPresenterService")
@Transactional
public class DocumentStorageListPresenterServiceImpl extends BaseService implements DocumentStorageListPresenterService {
  @Autowired
  ...
  public Collection<UIDocumentStorage> loadDocumentStorageList(final IDocumentContainerProxy context) throws SessionTimeOutException, ValidationException {
    IDocumentContainer _resolved= null;
    if(context!=null) _resolved=(edu.fudan.langlab.domain.document.IDocumentContainer)com.uniquesoft.uidl.extensions.ModelObjects.resolve(context, entities);
    ...
    final Function1<IDocument,UIDocumentStorage> _function = new Function1<IDocument,UIDocumentStorage>() {
        public UIDocumentStorage apply(final IDocument it) {
          UIDocumentStorage _transform = DocumentStorageListPresenterServiceImpl.this.mapper.transform(((DocumentStorage) it));
          return _transform;
        }
      };
