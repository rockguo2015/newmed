...
import com.fudanmed.platform.core.web.client.device.StringValueDataForm;
...
public class StringValueEditorView extends ErrorNotifierViewer implements StringValueEditorPresenterView {
  @Inject
  ...
  @Inject
  private StringValueDataForm form;
  ...
  public StringValueData getValue() {
    StringValueData _value = this.form.getValue();
    return _value;
  }
