...
import com.fudanmed.platform.core.web.client.project.MaintenamceTypeForm;
...
public class CreateOrUpdateMaintenamceTypeView extends ErrorNotifierViewer implements CreateOrUpdateMaintenamceTypePresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private MaintenamceTypeForm form;
  ...
  public void initialize() {
    ...
    final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
        public void apply(final VerticalLayoutContainer it) {
          Widget _asWidget = CreateOrUpdateMaintenamceTypeView.this.form.asWidget();
          int _minus = (-1);
          VerticalLayoutData _VLayoutData = CreateOrUpdateMaintenamceTypeView.this.widgets.VLayoutData(1, _minus, 10);
  ...
  public UIMaintenamceType getValue() {
    UIMaintenamceType _value = this.form.getValue();
    return _value;
  }
  ...
  public void setValue(final UIMaintenamceType value) {
