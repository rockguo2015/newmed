...
public class RCOnsitePositionCriteriaImpl extends HQLBasedPagedQueryCriteria<RCOnsitePosition> implements RCOnsitePositionCriteria {
  private String info;
  ...
  public RCOnsitePositionCriteria setInfo(final String info) {
    this.info = info;
    return this;			
  ...
  protected String buildHQLFrom() {
    return " from com.fudanmed.platform.core.domain.impl.RCOnsitePositionImpl this ";
  }
  ...
  public RCOnsitePositionCriteriaImpl() {
    initOrderBys();
  }
}
