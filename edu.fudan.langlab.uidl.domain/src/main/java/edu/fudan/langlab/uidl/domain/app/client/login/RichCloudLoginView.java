...
public class RichCloudLoginView extends GWTAbstractView implements LoginPresenterView {
  @Inject
  ...
  public void initialize() {
    ...
    final Procedure1<FlowPanel> _function = new Procedure1<FlowPanel>() {
        public void apply(final FlowPanel it) {
              ...
              public void apply(final FlowPanel it) {
                ...
                final Procedure1<FlowPanel> _function = new Procedure1<FlowPanel>() {
                    public void apply(final FlowPanel it) {
                      ...
                      TextField _TextField = RichCloudLoginView.this.widgets.TextField();
                      ...
                      PasswordField _PasswordField = RichCloudLoginView.this.widgets.PasswordField();
                      ...
                      TextButton _TextButton = RichCloudLoginView.this.widgets.TextButton("\u767B\u5F55", _function_2);
                      ...
                      TextButton _TextButton_1 = RichCloudLoginView.this.widgets.TextButton("\u53D6\u6D88", _function_4);
          ...
          ObjectExtensions.<FlowPanel>operator_doubleArrow(_div_1, _function_1);
        }
      };
